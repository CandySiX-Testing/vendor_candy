...
PRODUCT_COPY_FILES += \
     ...
     vendor/candy/prebuilt/common/app/ViPER4Android/su.d/50viper.sh:system/su.d/50viper.sh
...
ifeq ($(CANDY_BUILDTYPE), RELEASE)
    ...
    CANDY_VERSION := CandySiX-$(PRODUCT_VERSION_MINOR)-$(CANDY_BUILD)-$(CANDY_BUILDTYPE)$(CANDY_EXTRAVERSION)-$(shell date -u +%m%d)
endif
